...
import com.yuze.user.api.AcOperationService;
...
@Transactional
@BaseService
public class AcOperationServiceImpl extends BaseServiceImpl<AcOperationMapper, AcOperation, AcOperationExample> implements AcOperationService {
