...
@Transactional
@BaseService
public class AcPermissionElementServiceImpl extends BaseServiceImpl<AcPermissionElementMapper, AcPermissionElement, AcPermissionElementExample, Integer> implements AcPermissionElementService {
