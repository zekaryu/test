...
import com.yuze.user.api.AcMenuService;
...
@Transactional
@BaseService
public class AcMenuServiceImpl extends BaseServiceImpl<AcMenuMapper, AcMenu, AcMenuExample> implements AcMenuService {
