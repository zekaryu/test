...
import com.yuze.user.api.AcUserAuthService;
...
@Transactional
@BaseService
public class AcUserAuthServiceImpl extends BaseServiceImpl<AcUserAuthMapper, AcUserAuth, AcUserAuthExample> implements AcUserAuthService {
