...
import com.yuze.user.api.AcUserRoleService;
...
@Transactional
@BaseService
public class AcUserRoleServiceImpl extends BaseServiceImpl<AcUserRoleMapper, AcUserRole, AcUserRoleExample> implements AcUserRoleService {
